...
{
    public static ConsoleEnterOrEscKeyResult PressEnterOrEscKey(
        bool showInstructions = true, 
        string enterVerb = "continue", 
        string escVerb = "exit")
    {
        if (showInstructions)
        {
    ...
    public static string? GetArgDirectiveValue(
        string[] args,
        string argDirective, 
        string argDirectivePrefix = "-")
    {
        bool found = false;

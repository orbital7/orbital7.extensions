...
public static class ProcessExecutionHelper
{
    ...
    public static ProcessExecutionResult GetProcessOutput(string fileName, string commandLineArgs)
    {
        return GetProcessOutput(fileName, commandLineArgs, 0);
    }

    public static ProcessExecutionResult GetProcessOutput(string fileName, string commandLineArgs, int secondsToTimeout)
    {
        var processOutput = new ProcessExecutionResult();

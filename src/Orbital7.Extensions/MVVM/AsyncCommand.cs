using Orbital7.Extensions.Events;
using System;
using System.Threading.Tasks;
using System.Windows.Input;

namespace Orbital7.Extensions.MVVM
{
    /// <summary>
    ...
    public sealed class AsyncCommand<T> : IAsyncCommand<T>
    {
        ...
        readonly Func<Exception, Task> _onException; //Action<Exception> _onException;
        ...
        public AsyncCommand(Func<T, Task> execute,
                            ...
                            Func<Exception, Task> onException = null, //Action<Exception> onException = null,
